...
const Auth: React.FC = () => {
    ...
    const renderForm = () => {
        const formProps = { onInputChange: handleInputChange, onSubmit: handleSubmit };

        switch (mode) {
            case 'login':
                return <LoginForm formData={formData} {...formProps} />;
            case 'register':
                return <RegisterForm formData={formData} {...formProps} />;
            case 'forgot':
                return <ForgotPasswordForm formData={formData} {...formProps} />;
        }
    };
